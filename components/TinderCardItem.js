        ...
        >
            ...
            >
                ...
                <div className={style.walletAddress}>
                    ...
                    {card.walletAddress.slice(39)}
                </div>
                <div className={style.reactionsContainer}>
                    <div
                        className={`${style.backColors} ${style.buttonContainer}`}
                    >
                        <FaUndoAlt
                    ...
                    <div
                        className={`${style.xColors} ${style.buttonContainer}`}
                    >
                        <AiOutlineClose
                    ...
                    <div
                        className={`${style.starColors} ${style.buttonContainer}`}
                    >
                        <AiFillStar
